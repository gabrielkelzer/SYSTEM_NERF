...
O criador desta ferramenta é o Gabriel Kelzer, ele criou a mesma para a KelzerBoy. Vale destacar que, esse script só funciona no Termux. 

Para baixar o Termux é só acessar o site do f-droid ou se preferir na Play Store.

O tutorial completo dessa ferramenta se encontra no GitHub: gabrielkelzer \033[0m'
                echo
                echo -e "\033[1;33mAPERTE ENTER PARA PROSSEGUIR:\033[0m"
                read SEGUE
            ;;
